  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <main className="flex-1 pt-24 md:pt-28">
        <section className="px-4 md:px-8 pt-10 md:pt-16 pb-8 md:pb-10">
                ...
                {["All", ...categories].map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className="text-xs font-bold uppercase tracking-wider px-4 py-2 rounded-full border transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2"
                      style={{
                        background: isActive ? copy.badgeBg : "transparent",
                        color: isActive ? copy.badgeText : copy.badgeBg,
                        borderColor: copy.badgeBg,
                        focusRingColor: copy.badgeBg,
                      }}
                    >
                      {cat}
                    </button>
