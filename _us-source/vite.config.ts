...
const BLOG_POST_SLUGS: Record<string, string[]> = {
  blog: [
    "complete-guide-start-moving-company-2026",
    "starting-moving-company-2026",
    "moving-company-startup-costs",
    "how-much-can-you-make-moving-company",
    "how-many-trucks-to-start",
    "moving-company-pricing-guide-2026",
    "moving-company-rate-card",
    "local-vs-long-distance-moving",
    "first-30-days-moving-company",
    "first-moving-job-guide",
    "real-cost-idle-moving-truck",
    "trucks-sitting-idle-moving",
    "relying-word-of-mouth-moving",
    "moving-company-marketing-2026",
    "why-moving-lead-sites-dont-work",
    "seo-vs-google-ads-vs-pay-per-move",
    "pay-per-move-vs-marketing-agencies",
    "scale-moving-company-one-truck-to-two",
    "signs-ready-scale-moving-business",
    "handle-moving-company-competition",
    "case-study-2-to-8-trucks",
    "add-moving-services-existing-business",
    "moving-services-side-hustle-scales",
  ],
  "dumpster/blog": [
